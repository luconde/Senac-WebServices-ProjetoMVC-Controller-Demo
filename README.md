# Visão Geral
Este é um projeto de demonstração de desenvolvimento de MVC com Laravel, Controller para About.
...
## Funcionalidades
1. Uma rota para responder quando chamar /sobre
2. Um Controller para responder /sobre
